...
class CategoryUnitTest extends TestCase
{
    ...
    {
        $this->expectException(CategoryInavalidArgumentException::class);
    ...
    public function it_can_delete_a_category()
    {
        ...
        $this->assertDatabaseHas('categories', collect($this->category)->all());
    }
    ...
    public function it_errors_finding_a_category()
    {
        ...
        $category = new CategoryRepository(new Category);
        $category->findCategoryById(9999);
    }
    ...
    public function it_can_find_the_category()
    {
        ...
        $this->assertEquals($this->category->name, $found->nome);
